-- Portale collaboratori: token personale non indovinabile + tabella contatti.
-- I collaboratori non hanno un account Auth: il portale valida il token
-- lato server (service role). Anon non deve poter leggere questa tabella.
